...
class MintDeleteRelInput(BaseModel):
    record_id: str = Field(..., description="ID of the record to delete a relationship from")
...
class MintDeleteRelTool(BaseTool, MintBaseTool):
    ...
    def _run(self, record_id: str, related_module: str, related_id: str, run_manager: Optional[CallbackManagerForToolRun] = None) -> Dict[str, Any]:
        try:
            ...
            result = suitecrm.Meetings.delete_relationship(record_id, related_module, related_id)
