...
class MintDeleteDataInput(BaseModel):
    module_name: str = Field(..., description="Name of the module in Mint in which the record is to be deleted")
...
class MintDeleteRecordTool(BaseTool, MintBaseTool):
    ...
    def _run(self, module_name: str, id: str, run_manager: Optional[CallbackManagerForToolRun] = None) -> Dict[str, Any]:
        try:
