...
class Module:
    ...
    def get(self, fields: list = None, sort: str = None, operator: str ='and',  **filters) -> list:
        """
        ...
        # Filter Constructor
        operators = {'=': 'EQ', '<>': 'NEQ', '>': 'GT', '>=': 'GTE', '<': 'LT', '<=': 'LTE',  'LIKE': 'LIKE', 'NOT LIKE': 'NOT_IKE', 'IN': 'IN', 'NOT IN': 'NOT_IN'}
